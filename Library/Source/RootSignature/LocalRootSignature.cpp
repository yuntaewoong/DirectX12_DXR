...
namespace library
{
    ...
    {
        m_rootParameter[static_cast<UINT>(ELocalRootSignatureSlot::CubeConstantSlot)].InitAsConstants(20u, 1u);//1번 레지스터에 32비트(4바이트) 값 20개를 쓰겠다(16개-XMMATRIX,4개->XMFLAOT4)
