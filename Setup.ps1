...
$zip_list  = @(
	...
	#>
	@(
		'https://gitlab.com/zhoub/pbrt-v3-scenes/-/archive/master/pbrt-v3-scenes-master.zip?path=bathroom',
		'Game/Assets/Scene',
		'bathroom.zip',
		'Game/Assets/Scene/bathroom'
	),
    @(
		'https://gitlab.com/zhoub/pbrt-v3-scenes/-/archive/master/pbrt-v3-scenes-master.zip?path=white-room',
		'Game/Assets/Scene',
		'whiteroom.zip',
		'Game/Assets/Scene/whiteroom'
	)
)
